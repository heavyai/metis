  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        this.objects = [];
        var _etype438 = 0;
        _rtmp3439 = input.readListBegin();
        _etype438 = _rtmp3439.etype;
        _size435 = _rtmp3439.size;
        for (var _i440 = 0; _i440 < _size435; ++_i440)
        {
          var elem441 = null;
          elem441 = input.readString().value;
          this.objects.push(elem441);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
OmniSci_unshare_dashboard_args.prototype.write = function(output) {
  ...
  if (this.groups !== null && this.groups !== undefined) {
    output.writeFieldBegin('groups', Thrift.Type.LIST, 3);
    output.writeListBegin(Thrift.Type.STRING, this.groups.length);
    for (var iter442 in this.groups)
    {
      if (this.groups.hasOwnProperty(iter442))
      {
        iter442 = this.groups[iter442];
        output.writeString(iter442);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  if (this.objects !== null && this.objects !== undefined) {
    output.writeFieldBegin('objects', Thrift.Type.LIST, 4);
    output.writeListBegin(Thrift.Type.STRING, this.objects.length);
    for (var iter443 in this.objects)
    {
      if (this.objects.hasOwnProperty(iter443))
      {
        iter443 = this.objects[iter443];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem450 = null;
          elem450 = new TDashboardGrantees();
          elem450.read(input);
...
OmniSci_load_table_binary_columnar_args.prototype.write = function(output) {
  ...
  if (this.cols !== null && this.cols !== undefined) {
    ...
    for (var iter467 in this.cols)
    {
      if (this.cols.hasOwnProperty(iter467))
      {
        iter467 = this.cols[iter467];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem474 = null;
          elem474 = new TStringRow();
          elem474.read(input);
          this.rows.push(elem474);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
OmniSci_load_table_args.prototype.write = function(output) {
  ...
  if (this.rows !== null && this.rows !== undefined) {
    output.writeFieldBegin('rows', Thrift.Type.LIST, 3);
    output.writeListBegin(Thrift.Type.STRUCT, this.rows.length);
    for (var iter475 in this.rows)
    {
      if (this.rows.hasOwnProperty(iter475))
      {
        iter475 = this.rows[iter475];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem482 = null;
          elem482 = new TColumnType();
          elem482.read(input);
          this.row_desc.push(elem482);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
OmniSci_create_table_args.prototype.write = function(output) {
  ...
  if (this.row_desc !== null && this.row_desc !== undefined) {
    ...
    for (var iter483 in this.row_desc)
    {
      if (this.row_desc.hasOwnProperty(iter483))
      {
        iter483 = this.row_desc[iter483];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem490 = null;
          elem490 = new TColumnType();
          elem490.read(input);
          this.row_desc.push(elem490);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
OmniSci_import_geo_table_args.prototype.write = function(output) {
  ...
  if (this.row_desc !== null && this.row_desc !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.row_desc.length);
    for (var iter491 in this.row_desc)
    {
      if (this.row_desc.hasOwnProperty(iter491))
      {
        iter491 = this.row_desc[iter491];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem514 = null;
          elem514 = input.readI64().value;
          this.outer_fragment_indices.push(elem514);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
OmniSci_start_query_args.prototype.write = function(output) {
  ...
  if (this.outer_fragment_indices !== null && this.outer_fragment_indices !== undefined) {
    ...
    for (var iter515 in this.outer_fragment_indices)
    {
      if (this.outer_fragment_indices.hasOwnProperty(iter515))
      {
        iter515 = this.outer_fragment_indices[iter515];
        output.writeI64(iter515);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
          ...
          for (var _i537 = 0; _i537 < _size532; ++_i537)
          {
            ...
            for (var _i545 = 0; _i545 < _size540; ++_i545)
            {
              ...
              for (var _i553 = 0; _i553 < _size548; ++_i553)
              {
                ...
                {
                  var elem562 = null;
                  elem562 = new TRenderDatum();
                  elem562.read(input);
                  val555.push(elem562);
                }
                input.readListEnd();
                val547[key554] = val555;
              }
              input.readMapEnd();
              val539[key546] = val547;
            }
            input.readMapEnd();
            val531[key538] = val539;
          }
          input.readMapEnd();
          this.merged_data[key530] = val531;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
OmniSci_execute_next_render_step_args.prototype.write = function(output) {
  ...
  if (this.merged_data !== null && this.merged_data !== undefined) {
    ...
    for (var kiter563 in this.merged_data)
    {
      if (this.merged_data.hasOwnProperty(kiter563))
      {
        var viter564 = this.merged_data[kiter563];
        output.writeString(kiter563);
        output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.MAP, Thrift.objectLength(viter564));
        for (var kiter565 in viter564)
        {
          if (viter564.hasOwnProperty(kiter565))
          {
            var viter566 = viter564[kiter565];
            output.writeString(kiter565);
            output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.MAP, Thrift.objectLength(viter566));
            for (var kiter567 in viter566)
            {
              if (viter566.hasOwnProperty(kiter567))
              {
                var viter568 = viter566[kiter567];
                output.writeString(kiter567);
                output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.LIST, Thrift.objectLength(viter568));
                for (var kiter569 in viter568)
                {
                  if (viter568.hasOwnProperty(kiter569))
                  {
                    var viter570 = viter568[kiter569];
                    output.writeString(kiter569);
                    output.writeListBegin(Thrift.Type.STRUCT, viter570.length);
                    for (var iter571 in viter570)
                    {
                      if (viter570.hasOwnProperty(iter571))
                      {
                        iter571 = viter570[iter571];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem578 = null;
          elem578 = input.readString().value;
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i609 = 0; _i609 < _size604; ++_i609)
        {
          ...
          val611 = input.readString().value;
          this.success[key610] = val611;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
OmniSci_get_device_parameters_result.prototype.write = function(output) {
  ...
  if (this.success !== null && this.success !== undefined) {
    ...
    for (var kiter612 in this.success)
    {
      if (this.success.hasOwnProperty(kiter612))
      {
        var viter613 = this.success[kiter612];
        output.writeString(kiter612);
        output.writeString(viter613);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem620 = null;
          elem620 = new TUserDefinedFunction();
          elem620.read(input);
          this.udfs.push(elem620);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem627 = null;
          elem627 = new TUserDefinedTableFunction();
          elem627.read(input);
          this.udtfs.push(elem627);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i633 = 0; _i633 < _size628; ++_i633)
        {
          ...
          this.device_ir_map[key634] = val635;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
OmniSci_register_runtime_extension_functions_args.prototype.write = function(output) {
  ...
  if (this.udfs !== null && this.udfs !== undefined) {
    ...
    for (var iter636 in this.udfs)
    {
      if (this.udfs.hasOwnProperty(iter636))
      {
        iter636 = this.udfs[iter636];
        iter636.write(output);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  if (this.udtfs !== null && this.udtfs !== undefined) {
    ...
    for (var iter637 in this.udtfs)
    {
      if (this.udtfs.hasOwnProperty(iter637))
      {
        iter637 = this.udtfs[iter637];
  ...
  if (this.device_ir_map !== null && this.device_ir_map !== undefined) {
    ...
    for (var kiter638 in this.device_ir_map)
    {
      if (this.device_ir_map.hasOwnProperty(kiter638))
      {
        var viter639 = this.device_ir_map[kiter638];
