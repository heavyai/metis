...
const resolvedFilter = (transforms: Array<Transform>, signal: string): Transform => {
...
export function resolveFilters (state: DataState): DataState {
  function reduceXFilters (transforms: Array<Transform>, transform: Transform): Array<Transform> {
